...
const Page = () => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      ...
      <section
        ref={ref}
        className="flex flex-col items-center justify-center h-[250px] bg-white dark:bg-gray-200 p-8 rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.2)] max-w-3xl mx-auto relative"
      >
